    ...
    <div class="container-fluid clearfix" id="sod-wrapper">
        ...
        <section class="col-sm-5 col-md-4 col-lg-3" id="main-menu">
          ...
          <div class="row sod-logo text-center">  <!-- school of design logo -->
            <img src="$ThemeDir/images/logo2.png" class="img-responsive hidden-sm hidden-xs" alt="">
            <img src="$ThemeDir/images/logo_sm.png" class="img-responsive hidden-md hidden-lg" alt="">
          </div>
          <!-- about text -->
